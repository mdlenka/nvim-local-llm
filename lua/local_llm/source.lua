...
function Source:enabled()
  ...
  if vim.tbl_contains(self.opts.disabled_filetypes or {}, ft) then return false end
  if vim.tbl_contains(self.opts.enabled_filetypes or {}, ft) then return true end
  return false
end
...
function Source:get_completions(ctx, callback)
  ...
  return function()
    ...
    if client_cancel then client_cancel(); client_cancel = nil end
  end
end
